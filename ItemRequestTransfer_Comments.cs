...
namespace AB
{
    public partial class ItemRequestTransfer_Comments : Form
    {
        public ItemRequestTransfer_Comments(int id, string reference)
        {
            InitializeComponent();
            this.id = id;
        ...
        public void loadData()
        {
            try
            {
                ...
                string sResult = apic.loadData("/api/forecast/target_for_delivery/comments/get_all/", sParams, "", "", Method.GET, true);
        ...
        private void ItemRequestTransfer_Comments_Load(object sender, EventArgs e)
        {
        ...
        private void btnAddComment_Click(object sender, EventArgs e)
        {
            ...
            ItemRequestTransfer_AddComment frm = new ItemRequestTransfer_AddComment(id, reference);
            frm.ShowDialog();

...
namespace AB
{
    public partial class ItemRequestTransfer_AddComment : Form
    {
        public ItemRequestTransfer_AddComment(int id, string reference)
        {
            InitializeComponent();
            this.id = id;
        ...
        private void ItemRequestTransfer_AddComment_Load(object sender, EventArgs e)
        {
        ...
        public void addComment()
        {
            try
            {
                ...
                string sResult = apic.loadData("/api/forecast/target_for_delivery/comments/new/", id.ToString(), "application/json", joBody.ToString(), Method.POST, true);

...
namespace AB
{
    public partial class GoodsIssued_ForIssue_Details : Form
    {
        public GoodsIssued_ForIssue_Details(int id, string reference)
        {
            InitializeComponent();
            this.id = id;
        ...
        DataTable dtBase = new DataTable(), dtForIssue = new DataTable();
        public static bool isSubmit = false;
        private void GoodsIssued_ForIssue_Details_Load(object sender, EventArgs e)
        {
        ...
        public void loadData()
        {
            ...
            string sResult = apic.loadData("/api/production/item_to_issue/get_all/", sParams, "", "", Method.GET, true);
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                try
                {
                    ...
                    {
                        MessageBox.Show("Remarks field is requried!", "Validation", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    }
                    else
                    {
                        ...
                        string whseCode = dtBase.Rows[0]["whsecode"].ToString();
                        joHeader.Add("whsecode", whseCode);
                        joBody.Add("header", joHeader);
                        JArray jaRows = new JArray();
                        foreach (DataRow row in dtForIssue.Rows)
                        {

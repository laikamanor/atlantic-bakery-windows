...
namespace AB
{
    public partial class GLAccounts2 : Form
    {
        public GLAccounts2()
        {
            InitializeComponent();
        ...
        private void GLAccounts2_Load(object sender, EventArgs e)
        {
        ...
        {
            string sParams = "";
            string sResult = apic.loadData("/api/glaccount/get_all", sParams, "", "", Method.GET, true);
                ...
                if (sResult.Substring(0, 1).Equals("{"))
                {
                    ...
                    gridControl1.Invoke(new Action(delegate ()
                    {
                        ...
                        foreach (GridColumn col in gridView1.Columns)
                        {
                            ...
                            col.DisplayFormat.FormatType = fieldName.Equals("amount") ? DevExpress.Utils.FormatType.Numeric : DevExpress.Utils.FormatType.None;
                            col.DisplayFormat.FormatString =  fieldName.Equals("amount") ? "n2" : "";

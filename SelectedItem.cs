    ...
    public partial class SelectedItem : Form
    {
        ...
        public void loadData()
        {
            if (dtSelectedItems.Rows.Count > 0)
            {
                ...
                {
                    dgv.Rows.Add(row["item_code"].ToString(), Convert.ToDouble(row["quantity"].ToString()), row["uom"].ToString(),row["whsecode"].ToString());
                }
            }
        }
        ...
        private void btnBack_Click(object sender, EventArgs e)
        {
            ...
            for(int i =0; i < dgv.Rows.Count; i++)
            {
                ...
                dtDgv.Rows.Add(itemName, quantity, uom,whseCode);
            }
                    ...
                    if (Login.jsonResult != null)
                    {
                        ...
                        if (!token.Equals(""))
                        {
                            ...
                            if(dgv.Rows.Count > 0)
                            {
                                ...
                                Console.WriteLine(jObjectBody.ToString());

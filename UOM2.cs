...
namespace AB
{
    public partial class UOM2 : Form
    {
        public UOM2()
        {
            InitializeComponent();
        ...
        private void UOM2_Load(object sender, EventArgs e)
        {
        ...
        {
            string sParams = "";
            string sResult = apic.loadData("/api/item/uom/getall", sParams, "", "", Method.GET, true);

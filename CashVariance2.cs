...
namespace AB
{
    public partial class CashVariance2 : Form
    {
        ...
        {
            checkTransDate.Checked = checkTransDate.Checked = true;
            dtTransDate.Value = dtTransDate.Value = DateTime.Now;
            loadBranch();
            loadData();
            cBranch = 0;
            cDate = 0;
        ...
        public void loadData()
        {
            if (Login.jsonResult != null)
            {
                ...
                if (!token.Equals(""))
                {
                    ...
                    var request = new RestRequest("/api/cashvar/get_all" + sBranch + sTransDate  + sNumber + sDocStatus);
                    Console.WriteLine("/api/cashvar/get_all" + sBranch + sTransDate  + sNumber + sDocStatus);
                            ...
                            if (x.Key.Equals("data"))
                            {
                                if (x.Value.ToString() != "[]")
                                {
                                    ...
                                    for (int i = 0; i < jsonArray.Count(); i++)
                                    {
                                        ...
                                        if (!txtSearch.Text.ToLower().Trim().Equals("search reference..."))
                                        {
                                            if (txtSearch.Text.ToString().Trim().ToLower().Equals(referenceNumber.ToLower()))
                                            {
        ...
        {
            if (txtSearch.Text.ToLower().Equals("search reference..."))
            {
        ...
        private void txtSearch_Leave(object sender, EventArgs e)
        {
            ...
            {
                txtSearch.Text = "Search Reference...";

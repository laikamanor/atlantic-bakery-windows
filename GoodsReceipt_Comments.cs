...
namespace AB
{
    public partial class GoodsReceipt_Comments : Form
    {
        public GoodsReceipt_Comments(int id, string reference)
        {
            InitializeComponent();
            this.id = id;
        ...
        public void loadData()
        {
            try
            {
                ...
                string sResult = apic.loadData("/api/production/rec_from_prod/comments/get_all/", sParams, "", "", Method.GET, true);
        ...
        private void GoodsReceipt_Comments_Load(object sender, EventArgs e)
        {
        ...
        private void btnAddComment_Click(object sender, EventArgs e)
        {
            ...
            GoodsReceipt_AddComment frm = new GoodsReceipt_AddComment(id, reference);
            frm.ShowDialog();

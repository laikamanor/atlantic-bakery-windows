...
namespace AB
{
    public partial class GoodsIssued_AddComment : Form
    {
        public GoodsIssued_AddComment(int id, string reference)
        {
            InitializeComponent();
            this.id = id;
        ...
        private void GoodsIssued_AddComment_Load(object sender, EventArgs e)
        {
        ...
        public void addComment()
        {
            try
            {
                ...
                string sResult = apic.loadData("/api/production/issue_for_prod/comments/new/", id.ToString(), "application/json", joBody.ToString(), Method.POST, true);

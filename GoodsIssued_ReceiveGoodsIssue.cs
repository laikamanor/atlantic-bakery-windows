...
namespace AB
{
    public partial class GoodsIssued_ReceiveGoodsIssue : Form
    {
        public GoodsIssued_ReceiveGoodsIssue()
        {
            InitializeComponent();
        }
        api_class apic = new api_class();
        devexpress_class devc = new devexpress_class();
        private void GoodsIssued_ReceiveGoodsIssue_Load(object sender, EventArgs e)
        {
        ...
        public void loadData()
        {
            ...
            string currentBranch = Login.jsonResult["data"]["branch"].ToString();
            string sParams = "?mode=confirm&docstatus=&branch=" + currentBranch;
                ...
                if (IsHandleCreated)
                {
                    gridControl1.Invoke(new Action(delegate ()
                    {
                        ...
                        foreach (GridColumn col in gridView1.Columns)
                        {
                            ...
                            col.Visible = !(fieldName.Equals("id") || fieldName.Equals("prod_order_id") || fieldName.Equals("series") || fieldName.Equals("objtype") || fieldName.Equals("seriescode") || fieldName.Equals("transnumber") || fieldName.Equals("docstatus") || fieldName.Equals("created_by") || fieldName.Equals("updated_by") || fieldName.Equals("canceled_by") || fieldName.Equals("date_canceled") || fieldName.Equals("date_updated") || fieldName.Equals("confirmed_by") || fieldName.Equals("date_confirmed") || fieldName.Equals("confirm") || fieldName.Equals("hashed_id") || fieldName.Equals("date_created"));
        ...
        private void repositoryItemTextEdit1_Click(object sender, EventArgs e)
        {
            ...
            {
                GoodsIssued_ReceiveGoodsIssue_Details.isSubmit = false;
                GoodsIssued_ReceiveGoodsIssue_Details frm = new GoodsIssued_ReceiveGoodsIssue_Details(id, selectedReference);
                frm.ShowDialog();
                if (GoodsIssued_ReceiveGoodsIssue_Details.isSubmit)
                {
                    bg();
                }
            }
